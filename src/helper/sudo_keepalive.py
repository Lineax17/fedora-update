...
class SudoKeepalive:
    ...
    def __init__(self, refresh_interval: int = 60):
        ...
        :param refresh_interval: Seconds between sudo refreshes (default: 60)
        """
    ...
    def _refresh_loop(self) -> None:
        """Background thread that refreshes sudo timestamp."""
...
def start(refresh_interval: int = 60) -> None:
    ...
    :param refresh_interval: Seconds between refreshes (default: 60)
    """
